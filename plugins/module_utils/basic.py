...
HAVE_SELINUX = False
try:
    from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.compat import selinux
    HAVE_SELINUX = True
except ImportError:
    pass
...
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.compat import selectors

from ._text import to_native, to_bytes, to_text
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.text.converters import (
    jsonify,
    container_to_bytes as json_dict_unicode_to_bytes,
    container_to_text as json_dict_bytes_to_unicode,
)

from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.arg_spec import ModuleArgumentSpecValidator

from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.text.formatters import (
    lenient_lowercase,
    bytes_to_human,
    human_to_bytes,
    SIZE_RANGES,
...
try:
    from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common._json_compat import json
...
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.file import (
...
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.sys_info import (
    get_distribution,
    get_distribution_version,
    get_platform_subclass,
)
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.pycompat24 import get_exception, literal_eval
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.parameters import (
    env_fallback,
    remove_values,
    sanitize_keys,
...
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common._utils import get_all_subclasses as _get_all_subclasses
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.parsing.convert_bool import BOOLEANS, BOOLEANS_FALSE, BOOLEANS_TRUE, boolean
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.warnings import (
    deprecate,
...
class AnsibleModule(object):
    ...
    def _set_internal_properties(self, argument_spec=None, module_parameters=None):
        ...
        # Remove future _ansible_* keys that we don't understand / care about
        # (For example, ansible-core 2.17 adds _ansible_ignore_unknown_opts and _ansible_target_log_info)
