...
if _system_distro:
    ...
    # Our bundled copy
    from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.distro import _distro as distro

sys.modules['ansible_collections.felixfontein.py2736compattest.plugins.module_utils.distro'] = distro
