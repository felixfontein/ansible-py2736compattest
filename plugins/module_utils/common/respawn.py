...
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.common.text.converters import to_bytes
...
def _create_payload():
    from ansible_collections.felixfontein.py2736compattest.plugins.module_utils import basic
