...
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.facts.virtual.base import Virtual, VirtualCollector
from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.facts.virtual.sysctl import VirtualSysctlDetectionMixin
