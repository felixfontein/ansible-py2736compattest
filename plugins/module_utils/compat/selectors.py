...
if _system_selectors:
    ...
    # Our bundled copy
    from ansible_collections.felixfontein.py2736compattest.plugins.module_utils.compat import _selectors2 as selectors  # type: ignore[no-redef]
sys.modules['ansible_collections.felixfontein.py2736compattest.plugins.module_utils.compat.selectors'] = selectors
